...
string Dog::getFeedSchedule() const 
{
    ...
    {
        return "Кормить 2 раза в день кормом для пожилых собак";
    }
}
...
string Dog::getTreatmentProtocol() const 
{
    ...
    protocol += "- Ежемесячная профилактика сердечного гельминтоза\n";
...
void Dog::printInfo() const 
{
    ...
    if (isVaccinated) 
    {
        cout << "Статус вакцинации: Вакцинирована" << endl;
    }
    else 
    {
        cout << "Статус вакцинации: Не вакцинирована" << endl;
    }
}
