...
{
    return "Кормить ежедневно специализированным зерновым кормом для птиц, свежими фруктами и овощами. Воду менять два раза в день.";
}
...
void Bird::printInfo() const 
{
    ...
    if (canFly) 
    {
        cout << "Может летать: Да" << endl;
    }
    else 
    {
        cout << "Может летать: Нет" << endl;
    }
}
